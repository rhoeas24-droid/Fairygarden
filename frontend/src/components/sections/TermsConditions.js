    ...
    >
      ...
      <div className="relative z-10 max-w-4xl mx-auto">
        ...
        >
          ...
          <h2 className="text-4xl md:text-5xl font-cinzel font-bold text-gold mb-4" data-testid="terms-title">
            {t('terms.title')}
          </h2>
        </motion.div>
        ...
        <motion.div
          ...
          className="bg-forest/60 backdrop-blur-md border border-gold/30 rounded-2xl p-8 md:p-12"
        >
          <div className="prose prose-invert prose-gold max-w-none font-montserrat text-cream/90 space-y-8">
            ...
            <div className="bg-gold/10 border border-gold/40 rounded-xl p-6" id="terms-chapter-5">
              <h3 className="text-xl font-cinzel font-bold text-gold mb-4 flex items-center gap-2">
                <span className="bg-gold text-forest px-2 py-1 rounded text-sm">★</span>
                {t('terms.chapter5.title')}
              </h3>
              <div className="text-cream/80 leading-relaxed space-y-4">
