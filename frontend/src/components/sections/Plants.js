...
const Plants = () => {
  ...
  return (
    <section id="plants" className="relative py-16 sm:py-20 lg:py-28 px-4 sm:px-6 bg-forest-dark">
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        >
          <Leaf className="w-12 h-12 sm:w-16 sm:h-16 text-gold mx-auto mb-4 sm:mb-6" />
          ...
          <p className="text-cream/80 font-montserrat text-sm sm:text-base lg:text-lg max-w-2xl mx-auto">
            Carefully selected and propagated terrarium plants. Each plant is grown in our greenhouse, 
            ensuring they're perfectly adapted for closed ecosystems.
          </p>
        </motion.div>
        ...
        {loading ? (
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4 sm:gap-6">
            {products.map((product, index) => (
              ...
              >
                <div className="bg-forest/50 backdrop-blur-sm border border-gold/20 rounded-xl overflow-hidden
          ...
          >
            <Leaf className="w-16 h-16 text-gold/30 mx-auto mb-4" />
            <p className="text-cream/60 font-montserrat text-lg">
              Plants coming soon! Check back later for our selection of terrarium plants.
            </p>
          </motion.div>
        )}
      </div>
