...
import { Leaf, Bug, Layers, ShoppingCart, Eye } from 'lucide-react';
                ...
                <div className="bg-forest/50 backdrop-blur-sm border border-gold/20 rounded-xl overflow-hidden
                  ...
                  <div className="relative aspect-square overflow-hidden">
                    ...
                    <div className="absolute top-2 left-2">
                      <span className={`px-2 py-1 text-xs font-montserrat font-semibold rounded-full
                        ${product.productType === 'plants' ? 'bg-green-600/80 text-white' : 'bg-amber-600/80 text-white'}`}>
                        {product.productType === 'plants' ? 'Plant' : 'Substrate/Bug'}
                      </span>
                    </div>
